...
default:Dict[str, Dict[str,object]] = {
    ...
    "paths": {
        ...
        'file_save_path_empreendimentos_imobme': f'C:/Users/{getuser()}/PATRIMAR ENGENHARIA S A/RPA - Documentos/RPA - Dados/Relatorio_Imobme_Financeiro/Empreendimentos.json'
    }
}
